...
println("DIAG agoSigningKeystorePath=[$agoSigningKeystorePath] exists=${agoSigningKeystorePath?.let { file(it).exists() }} local.properties.exists=${agoLocalPropertiesFile.exists()}")
